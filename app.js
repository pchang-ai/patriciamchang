    ...
    if (mapContainer && mapPins.length > 0) {
        ...
        if (saveBtn) {
            saveBtn.addEventListener('click', () => {
                ...
                // Show prompt with coordinates to easily copy/paste to the assistant
                prompt("To make these coordinates permanent on the live site, copy the JSON below and paste it in the chat with the assistant:", JSON.stringify(coords));
            });
        }
